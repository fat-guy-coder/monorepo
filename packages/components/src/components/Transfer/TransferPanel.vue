<template>
  <div class="transfer-panel">
    <div class="panel-header">
      <Checkbox :model-value="allChecked" :indeterminate="isIndeterminate" @update:model-value="handleAllCheck">
    ...
    <div class="panel-body">
      ...
      <ul class="option-list">
        <li v-for="option in filteredOptions" :key="option.key">
          <Checkbox :model-value="isChecked(option.key)" :disabled="option.disabled"
