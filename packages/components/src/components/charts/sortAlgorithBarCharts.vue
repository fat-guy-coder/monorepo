  ...
  <div class="sorting-visualizer">
    <div class="controls">
      <div class="control-group">
        ...
        <Input id="arraySize" type="range" min="5" max="100" v-model:value="arraySize" @change="generateRandomArray" />
        <span>5-100</span>
      ...
      <div class="control-group">
        ...
        <Input id="valueRange" type="range" min="50" max="2000" v-model:value="valueRange"
      ...
      <div class="control-group">
        ...
        <Select id="algorithm" style="width: 100px" v-model:value="selectedAlgorithm"
          :options="algorithms.map((item) => ({ label: item, value: item }))" :default-value="selectedAlgorithm">
        </Select>
      </div>
    ...
    <div class="log">
      <div class="log-title">
        <div>排序日志</div>
        <div>
          <Select style="width: 100px" v-model="logCount" :options="logCountOptions" :default-value="10" />
