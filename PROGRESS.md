...
| 1-3 | 运算符与表达式 | ✅ | ✅ | ✅ |
| 1-4 | fmt 格式化输入输出 | ✅ | ✅ | ✅ |
| 1-5 | 控制结构 (if/for/switch/goto) | ⏳ 待填充 | ✅ | — |
| 1-6 | 函数基础 | ✅ | ✅ | ✅ |
...
**下一个待填充: go-1-5-control-flow.vue (控制结构)**

## 阶段 2 — 并发编程 (Go .go 文件)

| 有内容 (4/13) | 待实现 (9/13) |
|--------------|--------------|
| go-2-1 goroutine ✅ | go-2-4 timer-ticker ⏳ |
| go-2-2 channels ✅ | go-2-6 sync-wg-once ⏳ |
| go-2-3 select ✅ | go-2-7 atomic ⏳ |
| go-2-5 sync-mutex ✅ | go-2-8 context ⏳ |
| | go-2-9 patterns ⏳ |
| | go-2-10 race ⏳ |
| | go-2-11 sync-pool ⏳ |
| | go-2-12 errgroup ⏳ |
| | go-2-13 goroutine-leak ⏳ |
