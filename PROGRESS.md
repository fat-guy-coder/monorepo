...
> 更新时间: 2026-08-14 | 当前活跃任务: **DSA 算法文档更新（模块 4 进行中 → 模块 13）**
...
- ⏳ 模块 4（树）：12/21 进行中（「树的定义与遍历」子主题 4 篇已全部完成，含菜单同步）
- ⏳ 模块 5-13：待填充

**继续指令：** 对 AI 说「继续 DSA 算法文档的更新，继续模块 4 树剩余 9 篇」

**模块 4 剩余待写（9 篇）：** dsa-4-1-3-construct、dsa-4-1-4-lca、dsa-4-2-2-successor、dsa-4-2-3-kth、dsa-4-3-2-rb-tree、dsa-4-3-3-treap、dsa-4-4-3-lsm、dsa-4-5-3-fenwick、dsa-4-5-4-union-find
...
| 任务 | 提示词 |
|------|--------|
| 继续 DSA 文档 | 「继续 DSA 算法文档的更新，从模块 3（哈希表）开始」 |
