...
__VLS_asFunctionalElement(__VLS_intrinsicElements.img)(__assign({ src: (__VLS_ctx.GitCommand), loading: "lazy", alt: "git-command" }, { class: "git-command" }));
/** @type {__VLS_StyleScopedClasses['tips']} */ ;
/** @type {__VLS_StyleScopedClasses['git-command']} */ ;
var __VLS_dollars;
