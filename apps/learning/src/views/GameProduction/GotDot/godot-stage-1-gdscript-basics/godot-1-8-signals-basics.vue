...
const navList = [{id:"sec-1",name:"概述"},{id:"sec-2",name:"声明→连接→发射"},{id:"sec-3",name:"带参数信号"},{id:"sec-4",name:"编辑器连接"},{id:"sec-5",name:"实战：生命值系统"},{id:"sec-6",name:"信号总线"},{id:"sec-7",name:"信号作为Callable"},{id:"sec-8",name:"常见错误"},{id:"sec-9",name:"小结"}]
