  ...
  <div class="go-doc min-h-screen bg-linear-to-br from-slate-50 to-blue-50">
    ...
    <main class="max-w-4xl mx-auto px-6 py-8 space-y-6">
      ...
      <section id="sec-3" class="bg-white rounded-2xl shadow-md p-6 border border-slate-100">
        <h2 class="text-lg font-semibold text-slate-800 mb-4 flex items-center gap-2"><span class="w-8 h-8 bg-cyan-100 text-cyan-700 rounded-lg flex items-center justify-center text-sm">2</span>常见陷阱</h2>
        <div class="space-y-4">
