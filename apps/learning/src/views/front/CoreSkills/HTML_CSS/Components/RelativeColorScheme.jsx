...
export var PaletteIcon = function () { return (<svg width="24" height="24" viewBox="0 0 24 24">
...
export var ThemeIcon = function () { return (<svg width="24" height="24" viewBox="0 0 24 24">
...
export var ContrastIcon = function () { return (<svg width="24" height="24" viewBox="0 0 24 24">
    <path d="M4,6H20V16H4M20,18A2,2 0 0,0 22,16V6C22,4.89 21.1,4 20,4H4C2.89,4 2,4.89 2,6V16A2,2 0 0,0 4,18H0V20H24V18H20Z"/>
  </svg>); };
export var GradientIcon = function () { return (<svg width="24" height="24" viewBox="0 0 24 24">
...
// 代码块组件
export var CodeBlock = defineComponent({
    setup: function (_, _a) {
        var slots = _a.slots;
        return function () {
            var _a;
            return (<pre class="code-block">
        <code>{(_a = slots.default) === null || _a === void 0 ? void 0 : _a.call(slots)}</code>
      </pre>);
        };
    },
});
