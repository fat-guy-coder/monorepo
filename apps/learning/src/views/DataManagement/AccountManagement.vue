<template>
  <div class="account-management">
    ...
    <div class="content">
      ...
      <Card title="账户操作">
        <div class="form-actions">
          <Button type="danger" @click="handleLogout" :loading="loggingOut">退出登录</Button>
        </div>
      </Card>
    </div>
  </div>
...
import { getUserInfo, clearTokens } from '@/utils/token'
import { putApiUserPassword, postApiUserLogout } from '@/api/user'

const router = useRouter()
const reloadMenus = inject<() => Promise<void>>('reloadMenus', async () => {})
