export const PiniaLogo = () => {
  return (
    <svg
      ...
      style="z-index: 1; width: 100%; --741733de: 0.29708170572916665; --3acb17ea: 0.0311358642578125; --490fb5c0: -0.29708170572916665;"
      data-v-27929700=""
    >
