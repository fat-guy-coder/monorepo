<template>
  <div class="code-block-container">
    ...
    <div class="code-toolbar">
      <span class="language-tag" v-if="!hiddenLanguageTag">{{ formattedLanguage }}</span>
      <button
        class="copy-button"
        @click="handleCopy"
        :disabled="isCopying"
        :aria-label="`复制${language}代码`"
        v-if="!hiddenCopyButton"
      >
    ...
    <pre
      ref="preElement"
      class="code-block"
      :class="[`language-${language}`, { 'line-numbers': lineNumbers }]"
...
const { code, language = 'js', lineNumbers = true, hiddenLanguageTag = false, hiddenCopyButton = false } =
  defineProps<{
    code: string
    language?: Language
    lineNumbers?: boolean
    hiddenLanguageTag?: boolean
