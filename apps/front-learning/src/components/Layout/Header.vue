<template>
  <header class="layout-header" :style="{
    height: `${headerState.isVisible ? headerState.size : 0}px`,
  }">
    <slot name="control">
      <div class="unified-trigger horizontal top" :class="{ 'is-hidden': !headerState.isVisible }">
        <div class="control-group">
          ...
          <label v-if="headerState.isVisible" class="control-item">
            <span>可折叠</span>
            <Switch v-model="headerState.collapsible" size="small" />
          </label>
