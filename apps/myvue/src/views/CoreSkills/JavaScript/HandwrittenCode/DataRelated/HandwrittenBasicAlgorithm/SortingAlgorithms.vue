<template>
  <div class="sorting-container">
    <h1>数组排序算法基本介绍</h1>
    <div class="intro">
      <p>排序是计算机科学中最基础的算法之一。本组件详细介绍了10种常见的排序算法，包括每种算法的基本思想、代码实现、使用场景、复杂度分析和优缺点。</p>
    </div>

    <div class="algorithm-grid">
      <div v-for="(algorithm, index) in algorithms" :key="algorithm.name" class="algorithm-card"
        :class="{ active: activeAlgorithm === index }" @click="activeAlgorithm = index">
...
const currentAlgorithm = computed(() => {
  return activeAlgorithm.value !== null
    ? algorithms[activeAlgorithm.value]
    : algorithms[0];
});
</script>
